...
//Switch causes problem, will be investigated later

/*    switch (slider.value) {
         case slider.value == 2006:
         geojson.setStyle(style2006);
         break;
         case slider.value == 2007:
         geojson.setStyle(style2007);
         break;
         case slider.value == 2008:
         geojson.setStyle(style2008);
         break;
         case slider.value == 2009:
         geojson.setStyle(style2009);
         break;
         case slider.value == 2010:
         geojson.setStyle(style2010);
         break;
         case slider.value == 2011:
         geojson.setStyle(style2011);
         break;
         case slider.value == 2012:
         geojson.setStyle(style2012);
         break;
         case slider.value == 2013:
         geojson.setStyle(style2013);
         break;
         case slider.value == 2014:
         geojson.setStyle(style2014);
         break;
         case slider.value == 2015:
         geojson.setStyle(style2015);
         break;
         case slider.value == 2016:
         geojson.setStyle(style2016);
         break;
       }
     };*/
      ...
      let mymap = L.map('mapid', {zoomControl:true, maxZoom: 12, minZoom: 5}).setView([51.5167, 9.9167], 5);
